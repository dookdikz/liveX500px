...
import com.example.tanawat.liveat500px.fragment.MoreInfoFragment;
...
initInstances();
        ...
        if(savedInstanceState==null){
            getSupportFragmentManager().beginTransaction().add(R.id.contentContainer, MoreInfoFragment.newInstance(dao)).commit();
        }
